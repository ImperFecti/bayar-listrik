...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 03, 2024 at 03:50 PM
...
(3, 'admin@gmail.com', 'admin', '$2y$10$J7TeggJu1l.Ko.4skySwleML4A1Gi7.SWPx1dVcEdlQB2HenvycCO', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2024-07-24 16:08:37', '2024-08-03 13:45:45', NULL, 'admin1', '', '', '', 1),
(7, 'admin2@gmail.com', 'admin2', '$2y$10$3lctvlMkiSj9d4V2uL4KK.HKDvE0xE3KzGMHmB9pSUH0sfcvtWxda', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2024-08-03 13:45:14', '2024-08-03 13:45:14', NULL, NULL, NULL, NULL, NULL, 0);
...
--
ALTER TABLE `pembayaran`
  ADD CONSTRAINT `pembayaran_id_users_foreign` FOREIGN KEY (`id_users`) REFERENCES `users` (`id`) ON DELETE CASCADE;
